...
const ChooseUs = () => {
  return (
    <div className="bg-white relative xl:mb-2 xl:pb-36 xl:pt-28 lg:py-24 md:py-20 sm:py-16 py-12 overflow-hidden">
      ...
      />
      <img
        className="absolute -top-[6%] lg:w-full md:block hidden max-w-[70px] xl:max-w-[100px] start-0 pointer-events-none -z-0"
        src={leftvec}
        alt="vector"
      />
      <img
      ...
      <div className="max-w-[1164px] mx-auto px-3 xl:mt-7">
        ...
        <h2 className="text-center text-black font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2 sm:mt-4 leading-sm font-hurme-bold">
          Get to Know Us: Where Innovation Meets Sky
        </h2>
          ...
          {chooseCards.map((card, index) => (
            ...
            >
              <div
                className={`flex ${
                  card.reverse
                    ? "flex-col-reverse sm:flex-col sm:justify-start justify-end"
                    : "flex-col"
                } bg-white min-h-[323px] border rounded-[10px] hover:border-lightOrange duration-300 transition-all hover:shadow-expertise p-3 border-grey`}
              >
                {card.reverse ? (
                  <>
                    <div className="flex flex-col-reverse sm:flex-col">
                      <p className="text-darkGrey font-poppins font-normal mt-[10px] text-sm md:text-base leading-md lg:max-w-[309px]">
                        {card.description}
                      </p>
                      <h5 className="font-poppins text-xl text-black font-semibold leading-md pt-3">
                        {card.title}
                      </h5>
                    </div>
